...
exports.execute = async(client, message, args) => {
    ...
    let embed = new MessageEmbed().setAuthor(`İlk Top:10`, message.guild.iconURL({dynamic: true})).setThumbnail(message.guild.iconURL({dynamic: true}))
...
exports.conf = {
  ...
  aliases: ["teyittop", "teyit-top", "kayıttop", "kayıt-top", "top"]
}